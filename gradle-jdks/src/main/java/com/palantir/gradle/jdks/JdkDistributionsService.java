...
import com.palantir.gradle.jdks.JdkDistributionsService.Params;
import org.gradle.api.services.BuildService;
import org.gradle.api.services.BuildServiceParameters;

public abstract class JdkDistributionsService implements BuildService<Params> {

    interface Params extends BuildServiceParameters {}

    private final JdkDistributions jdkDistributions;

    public JdkDistributionsService() {
