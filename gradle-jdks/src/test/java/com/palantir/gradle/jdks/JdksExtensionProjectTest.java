...
final class JdksExtensionProjectTest {
    ...
    @Test
    void correctlyHandlesMultiLevelVersionOverrides(GradleInvoker gradle) {
        rootProject.buildGradle().append("""
        ...
        assertTrue(output.contains("jdkVersion macos aarch64: 11.1"));
        assertTrue(output.contains("jdkVersion linux-glibc aarch64: 11.2"));
        assertTrue(output.contains("jdkVersion linux-glibc x64: 11.3"));
    }
}