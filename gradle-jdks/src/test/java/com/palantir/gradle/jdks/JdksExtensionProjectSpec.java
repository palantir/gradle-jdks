...
@GradlePluginTests
final class JdksExtensionProjectSpec {
    ...
    @Test
    void correctly_handles_multi_level_version_overrides(GradleInvoker gradle, RootProject project) {
        project.buildGradle()
                .append(
                        """
        ...
        assertThat(result).output().contains("jdkVersion macos aarch64: 11.1");
        assertThat(result).output().contains("jdkVersion linux-glibc aarch64: 11.2");
        assertThat(result).output().contains("jdkVersion linux-glibc x64: 11.3");
    }
}
