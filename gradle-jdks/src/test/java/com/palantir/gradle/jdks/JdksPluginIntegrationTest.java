...
@GradlePluginTests
public class JdksPluginIntegrationTest {
    ...
    void setup(RootProject rootProject, SubProject subProject) {
        ...
        // Create Java class for testing
        subProject.mainSourceSet()
                .java()
                .writeClass("""
                        package foo;
    ...
    @Test
    void canDownloadAndRunAzulZuluJdk(GradleInvoker gradle, RootProject rootProject, SubProject subProject) {
        rootProject.buildGradle()
                .append("""
                        jdks {
                            jdk(11) {
    ...
    @Test
    void canDownloadAndRunAmazonCorrettoJdk(GradleInvoker gradle, RootProject rootProject, SubProject subProject) {
        rootProject.buildGradle()
                .append("""
                        jdks {
                            jdk(11) {
    ...
    @Test
    void canDownloadAndRunGraalVMCommunityEditionJdk(GradleInvoker gradle, RootProject rootProject, SubProject subProject) {
        rootProject.buildGradle()
                .append("""
                        jdks {
                            jdk(11) {
    ...
    @Test
    void canAddCaCertsToJdk(GradleInvoker gradle, RootProject rootProject) {
        ...
        rootProject.buildGradle()
                .append("""
                        jdks {
                            ...
                            caCerts.put 'Our_Amazon_CA_Cert_1', '''-----BEGIN CERTIFICATE-----
        ...
        assertThat(result.output()).contains(amazonRootCa1Serial);
    }

    @Test
    void throwsExceptionIfNoJdkDefinedForMajorVersion(GradleInvoker gradle, SubProject subProject) {
